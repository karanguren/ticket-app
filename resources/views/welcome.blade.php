    ...
    <footer>
        ...
        <div class="left-[10px] fixed bottom-[20px] px-[15px] py-[10px] text-sm bg-transparent">
            <div class="text-center flex flex-col justify-center">
                <a href="https://api.whatsapp.com/send?phone=584143669987&text=%C2%A1Hola!%20%F0%9F%91%8B%0A%0ATengo%20una%20consulta%20sobre%20la%20rifa..." target="_blank" class="mb-[20px] ml-[0px] w-[23px]">
