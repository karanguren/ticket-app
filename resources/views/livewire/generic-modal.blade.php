<div>
    <div id="Modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 {{ $showModal ? 'flex' : 'hidden' }}">
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 md:p-8 z-10 w-full max-w-md mx-auto relative transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg leading-6 font-medium text-red-900">¡Bienvenido!</h3>
                <button wire:click="closeModal" type="button" id="closeModalBtn" class="text-gray-400 hover:text-gray-600">
            ...
            <div class="flex justify-end">
                <button wire:click="closeModal" type="button" class="px-6 py-2 bg-red-600 text-white font-semibold rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                    Entendido
                </button>
            </div>
        </div>
