<div>
    <div id="confirmPaymentModal" class="fixed inset-0 z-50 {{ $showModal ? 'flex' : 'hidden' }} items-center justify-center p-4">
        <div class="relative p-5 border max-w-lg w-full shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg leading-6 font-medium text-[#ef4848]">Notifica tu pago</h3>
            ...
            <form wire:submit.prevent="confirmPayment">
                <div class="mt-2 px-7 py-3">
                    <div class="w-full">
                        ...
                        <flux:button type="submit" class="mt-5" variant="danger" icon="arrow-up-right">
                            CONFIRMAR PAGO
                        </flux:button>
                    </div>
                </div>
